...
$active_method = $router->methodName();
$controller_name = str_replace("\App\Controllers"," ",$router->controllerName()); 
$active_controller = preg_replace('/[^a-zA-Z0-9_%\[().\]\\/-]/s', '',$controller_name);
...
<head>
	...
	<link href="<?=base_url('assets/bundles/')?>/jr.css" rel="stylesheet">
...
<!--End Code Modal-->
  ...
  var MEDIA_UPLOAD_URL = '<?=MEDIA_UPLOAD_URL?>'; 
  var BASE_URL_JR = '<?=BASE_URL_JR?>'; 
  </script>  
