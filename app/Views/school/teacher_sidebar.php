            ...
            <div class="main-header-right row">
                ...
                <div class="nav-right col">
                    <ul class="nav-menus">
                        ...
                        <li><a href="<?=base_url('school');?>"><?php if(session()->get('voltAccountType')=="admin") { echo "Switch Admin Dashboard";}?></a></li>
                        ...
                        <li class="onhover-dropdown">
                            ...
                            <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                                <li><a href="<?=base_url();?>/school"><i data-feather="user"></i>Dashboard</a></li>
            ...
            <div class="page-sidebar">
                ...
                <div class="sidebar custom-scrollbar">
                    ...
                    <ul class="sidebar-menu">
                        <li><a class="sidebar-header" href="<?=base_url();?>/teacher"><i data-feather="home"></i><span>Dashboard</span></a></li>
                        <li><a class="sidebar-header" href="<?=base_url();?>/teacher/profile"><i data-feather="camera"></i><span>Profile</span></a></li>
                        <li><a class="sidebar-header" href="<?=base_url();?>/teacher/period"><i data-feather="archive"></i><span>My Classes</span></a></li>
                        <li><a class="sidebar-header" href="<?=base_url();?>/teacher/assignment"><i data-feather="archive"></i><span>Share Notification</span></a>
                        </li>
