...
echo $cls->slug;?>/<?php echo $month; ?>">
                                ...
                                <i class="fa fa-angle-right"></i>
                                <a
                                    href="<?=base_url()?>theme-category/<?php echo base64_encode($series->slug); ?>/<?php echo $month; ?>">
...
#shuffle($qns_tf_list);
        ...
        foreach ($fib_ans_list as $key => $fib_value) {
            ...
            echo '<div class="row col-md-12 mt-20 fibClick viewscore"  id="' . $qns_data_fib[$fib_sh - 1]['id'] . '">
                        ...
                        <div class="activity-section MchBox">
                            ...
                            <div class="excbuttons1" id="buttons">
                                ...
                                <a href="<?=base_url('playactivity/' . $mchpageurl . '&mk=' . $mchkey);?>"
                                    class="btn <?=($mchkey == $this->input->get('mk')) ? 'btn-primary' : 'blue';?>">Exercise
                                    <?=$mchkey + 1;?></a>
                                <?php }?>
                    ...
                    <div class="col-md-9 newactivityarea  bdr-rignt" id="vid">
                        <?php $pdf_url = (strpos($qns_data_vid[0]['url'], '/veb/')) ? $qns_data_vid[0]['url'] . "?token=" . $this->session->userdata('voltAccountToken') : ''; ?>
                    ...
                    <div class="col-md-9 newactivityarea " id="vid">
                        <?php
                        $pdf_url = (strpos($qns_data_vid[0]['url'], '/veb/')) ? $qns_data_vid[0]['url'] . "?token=" . $this->session->userdata('voltAccountToken') : '';
                        ?>
                        <h2 class="vidtitle"><?=$chapter->chapT_name?></h2>
                        <div class="vidbg" id="vdo">
                            <iframe allowfullscreen style="width: 100%; height: auto; min-height: 434px;"
        ...
        ?>
            ...
            echo 'next-div" style="display:none;';
                    ...
                    <div class="col-md-9 newactivityarea  bdr-rignt" id="ebook">
                        <?php $pdf_url = $qns_data_ebook[0]['url'] . "?token=" . $this->session->userdata('voltAccountToken');?>
    ...
    $vurl = (strpos($video['url'], '/veb/')) ? $video['url'] . "?token=" . $this->session->userdata('voltAccountToken') : '';
