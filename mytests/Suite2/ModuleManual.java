...
public class ModuleManual {
	...
	public void testUntitledTestCase() throws Exception {
		...
		new Select(driver.findElement(By.id("changeCls"))).selectByVisibleText("Class 8");
		...
		driver.findElement(By.name("mtitle")).sendKeys("module13", Keys.TAB,Keys.TAB,Keys.ENTER); //module name
