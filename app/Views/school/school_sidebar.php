            ...
            <div class="main-header-right row">
                ...
                <div class="nav-right col">
                    <ul class="nav-menus">
                        ...
                        <li><a href="<?=base_url('teacher');?>">Switch Dashboard</a></li>
                        ...
                        <li class="onhover-dropdown"><i data-feather="bell"></i><span class="badge badge-pill badge-primary pull-right notification-badge">3</span><span class="dot"></span>
                            <ul class="notification-dropdown onhover-show-div p-0">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="media-body">
                                            <h6 class="mt-0"><span><i class="shopping-color  font-success" data-feather="shopping-bag"></i></span>Notification-1..!</h6>
                                            <p class="mb-0">Sub Notification</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="media">
                                        <div class="media-body">
                                            <h6 class="mt-0 txt-success"><span><i class="download-color font-success" data-feather="download"></i></span>Notification-2</h6>
                                            <p class="mb-0">Sub Notification</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="txt-dark"><a href="#">All Notifications</a></li>
                            </ul>
                        </li>
                        <li class="onhover-dropdown">
                            ...
                            <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                                <li><a href="<?=base_url();?>"><i data-feather="user"></i>Homepage</a></li>
            ...
            <div class="page-sidebar">
                ...
                <div class="sidebar custom-scrollbar">
                    ...
                    <ul class="sidebar-menu">
                        <li><a class="sidebar-header" href="<?=base_url()?>/school"><i data-feather="home"></i><span>Dashboard</span></a></li>
                        <li><a class="sidebar-header" href="<?=base_url()?>/school/info"><i data-feather="grid"></i><span>Institution Info</span></a></li>
                        <li><a class="sidebar-header" href="<?=base_url()?>/school/teacher/list"><i data-feather="user"></i><span>Users</span></a></li>
                        <li><a class="sidebar-header" href="<?=base_url()?>/school/class/info"><i data-feather="archive"></i><span>Classes</span></a></li>
                        <li><a class="sidebar-header" href="<?=base_url()?>/logout"><i data-feather="log-in"></i><span>Logout</span></a></li>
                    </ul>
                </div>
            </div>
            <!-- Page Sidebar Ends-->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="page-header-left">
                                    ...
                                    <small>School Admin panel</small>
                                </h3>
                            </div>
                        </div>
