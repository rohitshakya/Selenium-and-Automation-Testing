...
<section class="activity-page" id="">
    <div class="container-fluid">
       <div class="row justify-content-center">
               <div class="row col-md-12 col-xl-10">
                   
                    <?php if (count($qns_data_mcq) > 0) {?>
                    <div class="col-md-12 newactivityarea  bdr-rignt" id="mcq">
                     <div class="row justify-content-center wow fadeInUp">
                        <div class="col-lg-10 col-xl-10">
                         <h2 class="area-heading font-teal style-two mt-4 mb-1"><?=$catactivity->cat_name?></h2>
                        </div>
                     </div>     
                      ...
                      <div class="row justify-content-center wow fadeInUp">
                        ...
                        ?>
                            <div class="quiz-section activity-section <?php if ($mcq_sh == '1') {
                                    echo 'first-div';
                                } else {
                                ...
                                <div class="row  justify-content-center col-md-12 mt-20">
                                    <input type="submit" class="col-md-2 btn blue col-md-offset-4 mr-30 show skip" value="Skip" id="skip-<?=$qmcqdata['id'];?>" />
                                    <input type="submit" class="col-md-2 btn show green next" data-id="<?=$qmcqdata['id'];?>" value="Submit" />
                                </div>
                                <?php }?>
                         ...
                         <?php if (!empty($act_value)) {
                                ...
                                <?php $tc = 1; foreach (array_unique($act_value) as $value) {
                                    if (in_array($value, $Type_Array)) { $Typas = ($cat_data_type_label[$value]) ? $cat_data_type_label[$value] : $Type_Value[$value];
                                    $act_cat = ($value == $curr_type) ? 'act-cat' : ''; ?>
                                    
                                  <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                 <div class="sin-download bg-reds wow fadeInLeft mb-4">
                                     <div class="down-text">
                                        <?php echo '<a class="box-a ' . $act_cat . ' box-a vdo vidlistdata" href="javascript:void(0);" id="' . $tc . '" data-setids="' . $set_Ids . '" data-target="#' . $value . '" data-class="' . $navpageurl . '" > ' . $Typas . '</a>'; 
                                        $tc++; ?>   
                                     </div>
                                 </div>
                                </div>
                    ...
                    <!-- ----------------------True and false--------------------- -->
                    <div class="col-md-12 newactivityarea  bdr-rignt tnfbg" id="tnf">
                      <div class="row justify-content-center wow fadeInUp">
                        <div class="col-lg-12 col-xl-10">
                            <?php
                            $qns_tf_data = '';
                    ...
                    <div class="col-md-12 newactivityarea  bdr-rignt fibbg" id="fib">
                      <div class="row justify-content-center wow fadeInUp">
                        <div class="col-lg-12 col-xl-10">
                            <?php
                            $qns_fib_data = '';
                    ...
                    <div class="col-md-12 newactivityarea  bdr-rignt" id="mch"> 
                      <div class="row justify-content-center wow fadeInUp">
                        <div class="col-lg-12 col-xl-10">
                        <div class="activity-section MchBox">
                            <div class="text-center mt-4 font-teal style-two mb-1">
                                <?php if ($qns_data_mch[$mchQnsKey]['question']) {?>
                                 <h3 class="area-heading"><?=$catactivity->cat_name?></h3>
                                <p class="subarea-heading"><?php echo $qns_data_mch[$mchQnsKey]['question']; ?></p>
                                <?php }?>
                            </div>
                            <div id="cardPile" class="row mchbg">
                    ...
                    <!-- ----------------------Watch--------------------- -->
                    <div class="col-md-12 newactivityarea " id="vid">
                    ...
                    <div class="row justify-content-center wow fadeInUp">
                        ...
                        <iframe allowfullscreen style="width: 100%; height: auto; min-height: 500px;" class="video-player" src="<?=$pdf_url?>"></iframe>
                        </div>
                        </div>
                    </div> 
                    <?php if (@count(@$qns_data_vid) > 1) {?>
                    <div class="row justify-content-center wow fadeInUp" data-wow-delay=".3s">
                        <div class="row col-lg-10 col-xl-10">
                             <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                 <div class="sin-download bg-reds wow fadeInLeft mb-4">
                                     <div class="down-text">
                                        <?php foreach ($qns_data_vid as $video) {
                                        $vurl = (strpos($video['url'], '/veb/')) ? $video['url'] . "?token=" . session('voltAccountToken') : '';
                                        echo '<a class="box-a vdo vidlistdata" href="javascript:void(0);" data-id="' . $video['id'] . '"  data-url="' . $vurl . '" >' . $video['question'] . '</a>';
                                        } 
                                        ?>
                                     </div>
                                 </div>
                   ...
                   <?php }?>
                    ...
                    <!-- ----------------------ebook--------------------- -->
                    <div class="col-md-12 newactivityarea  bdr-rignt" id="ebook">
                    ...
                    <div class="col-lg-6 col-xl-10">
                      ...
                      <iframe allowfullscreen src="<?=$pdf_url?>" id="eb" title="" style="width: 100%; height: auto; min-height: 500px;"></iframe>
                        </div>
                    </div>
                    </div>  
                             ...
                             <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                                 <div class="sin-download bg-reds wow fadeInLeft mb-4">
                                     <div class="down-text">
                                        ...
                                        <?php $url = $ebook['url'] . "?token=" . session('voltAccountToken');
                                        echo '<a class="box-a vdo vidlistdata" href="javascript:void(0);" data-type="' . $ebook['type'] . '"  data-url="' . $url . '" >' . '&nbsp;&nbsp;' . $ebook['question'] . '</a>';
                                        }
                                        ?>
                                     </div>
                                 </div>
                    ...
                    <!-- ----------------------Infographics-------------------------------- -->
                    <div class="col-md-12 newactivityarea bdr-rignt" id="imgtext">
                        <?php
                            $qns_info_data = '';
                            $info_sh = 1;
   ...
   <?php if ($allcategories) { $int = 0; ?>
            <section class="kids-care-teachers-area">
                <div class="container-fluid custom-container">
                    <div class="row justify-content-center wow fadeInUp">
                        <div class="col-xl-10">
                            <h2 class="area-heading font-green mb-4">Related Activity</h2>
                        </div>
                    </div>
                    <div class="inner-container">
                    <div class="row justify-content-center wow fadeInUp">

                <?php foreach ($allcategories as $getCategory) {
                $urlIs = "#active";
                ...
                if (@count($checkList) > 0) {
                    ...
                    $activityurl2 = base_url('playactivity' . $Usod . $Utyp . '?c=' . preg_replace("/activity\d/i", "activity" . $getCategory->cat_id, $request->getGetPost('c')));      
                        
                    ?>
                                

	           <div class="single-teacher col-sm-2 item">
					<a href="<?=($listenPos == false) ? $activityurl2 : "javascript:void(0)"?>"  class="inner-prog <?=($listenPos == true) ? 'playvideo' : ''?>"  style="display:block; padding: 20px 0; box-shadow: 0px 0px 8px #656363; background:#<?=$getCategory->cat_bg?>">
						<div class="acticity-img"  data-type="<?=$dataTypeis?>" data-video-url="<?=$checkList->url?>">
							 <img src="<?=base_url('master/uploads/category/' . $getCategory->cat_img)?>"
                                            class="center-block" style="width:75px;">
						</div>
						<div class="acticity-name">
    ...
    <div class="container" id="act_result">
        <div class="card">
            <div class="">
                ...
                <div class="row justify-content-center score-header">
   ...
   <?php if (count($qns_data_fib) > 0) {
        ...
        echo '</ul></div></li>';
                    ...
                    <div class="col col-md-4 col-sm-4 col-xs-4">
                        ...
                        <p class="badge" style="color: #000; background: #f0ad4e;font-size: 20px;">Skipped : <span
